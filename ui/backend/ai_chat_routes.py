"""
AI assistant chat routes — FastAPI router for the AI chat endpoint.
...
from jobs_service import normalize_timestamp
...
def _resolve(name: str):
    ...
    This keeps tests working: they patch ``app.ai_service``, etc., and
    this function reads the patched value instead of a stale import-time
    reference.
    """
