...
# Notification routes (router + helpers)
from notification_routes import router as notification_router, _init_services as _init_notification_services
_init_notification_services(slack_service, email_service)
app.include_router(notification_router)

# AI chat routes (router for /api/ai-assistant/chat)
from ai_chat_routes import router as ai_chat_router, ai_assistant_chat
app.include_router(ai_chat_router)

# Static routes (router for lightweight/mostly-static endpoints)
...
# NotificationSettings and send_cluster_notifications moved to notification_routes.py
# Re-exported here for backward compatibility (tests patch "app.send_cluster_notifications", etc.)
...
# API Routes — root, health, versions, templates, analyze-yaml moved to static_routes.py
...
# Notification Settings endpoints moved to notification_routes.py


# User Journey APIs — onboarding, diagnostics, environment moved to static_routes.py


# Credentials & status-check routes -- moved to credentials_routes.py
# Re-export everything for backward compatibility (tests patch "app.get_rosa_status", etc.)
...
# The following block was removed and now lives in credentials_routes.py:
#   get_config_status, get_credentials, save_credentials, CredentialsUpdate,
#   get_ocp_connection_status, _get_ocp_connection_status_sync,
#   get_aws_credentials_status, get_guided_setup_status


# user/profile, build/templates moved to static_routes.py

# validate endpoint — delegates to static_routes but keeps ClusterConfig type annotation
# here because static_routes.py cannot import ClusterConfig without circular imports.
@app.post("/api/validate")
async def validate_config(config: ClusterConfig):
    """Validate cluster configuration"""
    return await _validate_config_impl(config)
...
# ── MCE features / YAML / resources (moved to mce_features_routes.py) ────
...
# AI assistant chat endpoint moved to ai_chat_routes.py

# Test Suite routes (router + helpers) -- moved to test_suite_routes.py
...
# ============================================================================
# Workflow + Trigger Management API -- moved to workflow_routes.py
# ============================================================================
# Re-export everything for backward compatibility (tests patch "app.WORKFLOWS_FILE",
# "app._load_workflows", "app._fire_and_update", "app._get_trigger_or_404", etc.)
...
# trigger_service symbols (still re-exported for backward compat)
...
# Cluster-actions + ClusterAutomationSpec routes -- moved to cluster_actions_routes.py
# Re-exported here for backward compatibility (tests patch "app._find_feature", etc.)
from cluster_actions_routes import (
    ...
    _execute_cluster_actions_locked,
    get_action_history,
...
# ============================================================================
# MCE Environment Management API -- moved to mce_environments_routes.py
# ============================================================================
...
# ── AWS dashboard / Jenkins / GitHub (moved to aws_dashboard_routes.py) ───
