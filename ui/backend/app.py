...
@app.get("/api/agents/remediation-metrics")
...
@app.get("/api/agents/knowledge-base")
...
@app.post("/api/agents/pending-learnings/{index}/approve")
...
@app.post("/api/agents/pending-learnings/{index}/reject")
