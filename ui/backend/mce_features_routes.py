"""
MCE Features routes -- FastAPI router for MCE feature/YAML/resource endpoints.

Endpoints moved here from app.py:
  GET  /api/mce/features    (MCE features and enablement status)
  GET  /api/mce/yaml        (MultiClusterEngine resource YAML)
  GET  /api/mce/resources   (CAPI/CAPA resources from MCE environment)

Also contains:
  _get_mce_features_sync()  -- sync helper for MCE features
"""
