"""
Test Suite Management service module -- FastAPI router for test-suite
CRUD, execution, status, and history endpoints.
...
Also contains:
  test_suite_runs          -- module-level dict for run history
  TestSuiteRun             -- Pydantic request model
  run_test_suite_background -- sync helper launched via asyncio.to_thread
"""
...
async def run_test_suite(run_config: TestSuiteRun, background_tasks: BackgroundTasks):
    ...
    try:
        ...
        # Access shared jobs dict via shared_state
